...
const Dashboard = () => {
   ...
   useEffect(() => {
      const getSurveys = async () => {
         const res = await fetch('https://online-survey-api.vercel.app/api/surveys');
   ...
   const handleDelete = async (surveyId) => {
      try {
         const res = await fetch(`https://online-survey-api.vercel.app/api/surveys/${surveyId}`, {
            method: 'DELETE',
            headers: {
   ...
   const handleCreateSurvey = async () => {
      try {
         const res = await fetch('https://online-survey-api.vercel.app/api/surveys/empty', {
            method: 'POST',
            headers: {
               'Content-Type': 'application/json',
            },
